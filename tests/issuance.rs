...
fn issue_nia(wallet_desc: DescriptorType, close_method: CloseMethod) {
    ...
    let terms_media_fpath = Some("README.md");
    ...
    assert_eq!(terms_media.ty.to_string(), "text/plain");
    assert_eq!(
        terms_media.digest.to_string(),
        "6734bfa623ee0810bbe1a0d1e14b47899f0760fa10b3d217b4686a1b417ca27a"
    );
...
fn issue_uda(wallet_desc: DescriptorType, close_method: CloseMethod) {
    ...
    let token_data_attachment = attachment_from_fpath("README.md");
